<script setup lang="ts">
	...
	import { generateChartDataConfig, getChartOptionsConfig } from '@//pages/positionAnalysis/constants/chart';
...
<template>
	<div class="py-6 px-3 grid gap-6 grid-cols-[1026px_1fr]">
		<div class="space-y-4">
			...
			<Chart class="chart" type="line" :options="chartOptions" :data="chartData" ref="chart" />
		</div>
		<div class="">
			<div class="space-y-[18px]">
				<div class="block">
					...
					<div>
						...
						<p class="description">
							Колбасные изделия и полуфабрикаты для народа от Емельянов. Работаем для вас! Доставка. От
							производителя. Опт мелкий. Опт крупный
						</p>
					</div>
				</div>
				<div class="block">
					<div>
						...
						<InputField disabled class="input-field w-full" icon="lock" v-model="relevantUrl" />
					</div>
					<div>
						<div class="title-wrapper">
						...
						<div class="flex items-center gap-2">
							<Input class="input-field w-full" icon="lock" v-model="targetUrl" />
